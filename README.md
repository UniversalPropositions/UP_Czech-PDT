...
- `git clone https://github.com/UniversalPropositions/UP_Czech-PDT.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Czech-PDT>/ --input_up=<up_path_to_UP_Czech-PDT>/ --output=<path_to_UD+UP_Czech-PDT>/`
